...
public class Board {
	...
	public boolean getGameStatus() 
	{
         ...
         * @param pitShape - a pit object containing the count of marbles to distribute
	...
	private void wonOpponentMarbles(int lastMarbleDropped) 
	{
         ...
         * pit on the board.
         * @param pitShape - the chosen pit by the player.
         */
	public void choosePit(PitShape pitShape) 
	{
         ...
         * @param pitShape - the pit chosen by the player
